...
curl -s -X POST "$KEYCLOAK_URL/admin/realms/guacamole/clients" \
    ...
    -d '{
        ...
        "rootUrl": "http://192.168.49.2:30000",
        "redirectUris": ["http://192.168.49.2:30000/*"],
        "webOrigins": ["http://192.168.49.2:30000"],
        "adminUrl": "http://192.168.49.2:30000/"
    }'
...
curl -s -X POST "$KEYCLOAK_URL/admin/realms/jenkins/clients" \
    ...
    -d '{
        "clientId": "jenkins",
        "enabled": true,
        "rootUrl": "http://192.168.49.2:31000",
        "redirectUris": ["http://192.168.49.2:31000/*"],
        "webOrigins": ["http://192.168.49.2:31000"],
        "adminUrl": "http://192.168.49.2:31000/"
    }'
